...
define("EWR_PROJECT_ID", "{5E0D34F4-CF4F-4BFE-BA2E-9971073C46CC}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "TFM_Reports", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "216.172.176.35", "port" => 3306, "user" => "tfm_tfmdb", "pass" => "Blackice#1977", "db" => "tfm_ERP_DEV", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 't5FwmxEthGd24CnF', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/TFM_Reports.css", TRUE); // Project stylesheet file name
